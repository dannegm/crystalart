...
class SettingsController extends \BaseController {
	public function index () {
		$settings =  array(
			...
			'contact' => array(
				...
				'email.sales' => Settings::get('contact.email.sales'),
				'email.support' => Settings::get('contact.email.support'),
			),
			'third' => array(
				'google' => array(
	...
	public function putContactData () {
		...
		$newEmailSales = Input::get('email_sales');
		$newEmailSupport = Input::get('email_support');

		Settings::set('contact.email', $newEmail);
		Settings::set('contact.email.sales', $newEmailSales);
		Settings::set('contact.email.support', $newEmailSupport);
