...
@section('breadcrumb')
	...
	<li><a href="{{route('appanel.showrooms.index')}}">Showroom</a></li>
	<li>Editar</li>
	<li class="active">{{$showroom->uid}}</li>
@stop
			...
			<div class="col-lg-8">
				<div class="block block-bordered">
					...
					<div class="block-content">
						{{Form::open(array(
							'route' => array('appanel.showrooms.update', $showroom->uid),
							'method' => 'PUT',
								...
								<div class="col-md-12">
									...
									<div class="form-group">
										<div class="col-sm-12">
											<div class="form-material">
												...
												<input class="form-control input-lg" type="text" id="name" name="name" placeholder="Nombre del evento" value="{{$showroom->name}}">
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-12">
											<div id="permalink-preview">
												...
												<span class="text-op">{{URL::asset('/showrooms')}}/<b>{{$showroom->permalink}}</b></span>
											...
											<div id="permalink-form" style="display: none;">
												...
												<div class="input-group push-10-t">
													...
													<input class="form-control input-sm" style="font-weight: bold; font-size: 12px;" type="text" id="permalink" name="permalink" placeholder="permalink" value="{{$showroom->permalink}}">
												</div>
									...
									<div class="form-group" style="border-top: 1px solid #eee; border-bottom: 1px solid #eee; margin: 20px 0; padding-top: 20px">
										...
										<div id="img_cover" class="img-container" style="height: 150px; background: #444 center no-repeat; background-size: cover;
											background-image: url('{{route('appanel.picture.uid', array('uid' => $showroom->cover_uid))}}');">
										...
										<input type="hidden" id="pic_cover" name="pic_cover" value="{{$showroom->cover_uid}}" />
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<textarea id="description" name="description" placeholder="Descripción del evento">{{$showroom->description}}</textarea>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<textarea id="address" name="address" placeholder="Dirección del evento">{{$showroom->address}}</textarea>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<textarea id="contact" name="contact" placeholder="Datos de contacto">{{$showroom->contact}}</textarea>
										</div>
									</div>
									<div class="form-group">
										<div class="col-xs-6">
	                                        ...
	                                        <div class="js-datepicker input-group date" data-show-today-button="true" data-show-clear="true" data-show-close="true" data-side-by-side="true">
	                                            <input class="form-control" type="text" id="date" name="date" placeholder="Seleciona fecha y hora..." value="{{$showroom->date}}">
	                                            <span class="input-group-addon">
