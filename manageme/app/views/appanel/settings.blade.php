	...
	$(document).on('click', '.putContactData', function (e) {
		...
		$.post(
			'{{route("appanel.settings.contact.data")}}',
			{
				...
				'email_sales': $('#contact_email_sales').val(),
				'email_support': $('#contact_email_support').val(),
			},
			function (res) {
				setTimeout(function () {
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-group">
										<div class="col-sm-12">
                                            <div class="form-material">
                                                <input class="form-control" type="text" id="contact_email_sales" placeholder="sales@email.co" value="{{$settings['contact']['email.sales']}}" />
                                                <label for="contact_email_sales">E-mail de ventas.</label>
                                            </div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-12">
                                            <div class="form-material">
                                                <input class="form-control" type="text" id="contact_email_support" placeholder="support@email.co" value="{{$settings['contact']['email.support']}}" />
                                                <label for="contact_email_support">E-mail de soporte.</label>
                                            </div>
										</div>
									</div>
									<div class="form-group">
